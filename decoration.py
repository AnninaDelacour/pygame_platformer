...
class Sky:
    def __init__(self, horizon, style = 'level'):
        self.top = pygame.image.load('./graphics/decoration/sky/sky_top4.png').convert()
        self.middle = pygame.image.load('./graphics/decoration/sky/sky_middle1.png').convert()
        self.bottom = pygame.image.load('./graphics/decoration/sky/sky_bottom1.png').convert()
...
class Water:
    def __init__(self, top, level_width):
        ...
        n_amount_tiles = int((level_width + screen_width) / water_tile_width)
        self.water_sprites = pygame.sprite.Group()

        for tile in range(n_amount_tiles):
            x = tile * water_tile_width + water_start
            y = top
            water_sprite = AnimatedTile(192, x, y, './graphics/decoration/water')
...
class Clouds:
    def __init__(self, horizon, level_width, cloud_number):
        ...
        for cloud in range(cloud_number):
            ...
            cloud_sprite = StaticTile(0, x, y, cloud)
