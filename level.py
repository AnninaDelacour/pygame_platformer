...
class Level:
    def __init__(self, current_level, surface, create_overworld, change_coins, change_health):
        ...
        # sound
        self.coin_sound = pygame.mixer.Sound('./audio/coin_pickup.wav')
        self.coin_sound.set_volume(0.02)

        self.enemy_killed = pygame.mixer.Sound('./audio/toink_enemy_kill.wav')
        self.enemy_killed.set_volume(0.03)
            ...
            for col_index, val in enumerate(row):
                if val != '-1':
                    ...
                    if type == 'fg palms':
                        ...
                        if val == '5': sprite = Palm(tile_size, x, y, './graphics/terrain/palm_large', 64)
    ...
    def player_setup(self, layout, change_health):
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                ...
                if val == '1':
                    carrot_surface = pygame.image.load('./graphics/character_witch/pumpkin.png').convert_alpha()
                    sprite = StaticTile(tile_size, x, y, carrot_surface)
    ...
    def run(self):
        ...
        # enemy + constraints to change direction of enemies
