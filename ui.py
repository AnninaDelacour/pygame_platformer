...
class UI:
    def __init__(self, surface):
        ...
        # font
        self.font = pygame.font.Font('./graphics/font/Silkscreen-Regular.ttf', 40)
        self.game_over_text = pygame.font.Font('./graphics/font/Silkscreen-Regular.ttf', 80)
    ...
    def show_coins(self, amount):
        ...
        coin_amount_surf = self.font.render(str(amount), False, 'gray7')
